<template>
    <div class="home-blog">
        <div class="hero" :style="{ ...bgImageStyle }" id="hero">
            <div class="down" @click="moveContent">
...
export default {
  ...
  methods: {
    ...
    //移动底部内容
        moveContent(){
            let winHeight = document.getElementById('hero').clientHeight
            let navHeight = document.getElementsByClassName('navbar')[0].clientHeight
            document.documentElement.scrollTop = winHeight - navHeight - 3
        },
  }
}
</script>
    ...
    .home-blog {
        ...
        .hero {
            ...
            .down{
                ...
                padding:10px;
                animation: downTo 1.3s linear infinite;
                cursor: pointer;
